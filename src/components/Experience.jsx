  ...
  return (
    <div className="border-b border-neutral-900 pb-4">
        <motion.h1  whileInView={{opacity:1, y:0}} initial={{opacity:0, y:-100}} transition={{duration:0.5}}
         className="my-20 text-center text-5xl font-thin">Experience</motion.h1>
        <div>
            {EXPERIENCES.map((experience,index) => (
                <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                    ...
                    <h6 className="mb-2 font-semibold text-xl">{experience.role} - <span className="text-sm text-purple-400">{experience.company}</span></h6>
